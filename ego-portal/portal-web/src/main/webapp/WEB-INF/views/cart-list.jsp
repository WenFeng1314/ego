...
<div id="doc">
	...
	<div id="s_bdw">
		<div id="s_bd">
					...
					<table width="100%">
						...
						<tr>
							...
							<td align="right" colspan="5">
								<p>共666件商品，总重3.00kg</p>
								<p style="margin-top:10px;font-size:14px;">总计金额(不含运费)：￥8888.00(商品金额) - ￥0.00(返现金额)= <strong style="font-size:18px;color:#d80000;">￥8888.00</strong> </p>
							</td>
						</tr>
						<tr>
			...
			<%--<div id="gouWuCheKong">--%>
				<%--<div ><a href="#"><img src="${ctx}/images/slide-5.jpg" /></a></div>--%>
			...
			<script type="text/javascript">
					...
					function orderSubmit(){
						$.ajax({
							url:"http://localhost:8083/order/submit",
							data:$("#my_cart_form").serialize(),
							type:"get",
							dataType:"jsonp",
							jsonp:"callBackFunc",
							success:function(res){
								if(res.status==200){
									window.location.href="http://localhost:8083/order/wait";
								}
							},
							error:function(res){
								alert("提交订单失败");
					...
					function showProductsList(res){
						...
						for(i=0;i<result.length;i++){
							...
							htmlStr+='<input type="hidden" name="goodsVoList['+i+'].shopPrice" value="'+result[i].shopPrice+'" />';
							htmlStr+='<tr bgcolor="#fffaf1" id="goods_cart_tr_'+result[i].id+'">';
							htmlStr+='<td>';
							htmlStr+='<a href="#"><img class="smallpic" src="'+result[i].originalImg+'" width="80" height="80" /></a>';
							htmlStr+='<a href="#">'+result[i].goodsName+'</a>';
							htmlStr+='</td>';
							htmlStr+='<td><strong class="red">￥'+result[i].shopPrice+'</strong></td>';
							htmlStr+='<td>';
							htmlStr+='<div class="addinput">';
							htmlStr+='<input type="text" name="goodsVoList['+i+'].num" value="'+result[i].storeCount+'" id="qty_item_'+result[i].id+'" onKeyUp="setAmount.modify(\'#qty_item_'+result[i].id+'\')" class="stext"/>';
