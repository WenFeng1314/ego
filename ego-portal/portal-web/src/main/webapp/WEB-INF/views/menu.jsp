				...
				for(i=0;i<res.length;i++){
					...
					for(j=0;j<level_1.children.length;j++){
						...
						for(k=0;k<level_2.children.length;k++){
							...
							console.log(level_3);
							if(k==0){
								htmlStr+='<li class="first"><a href=${ctx}/search/goSearch?isCat=true&keywords='+level_3.id+'&desc='+level_3.name+'>'+level_3.name+'</a></li>';
							}else{
								htmlStr+='<li><a href=${ctx}/search/goSearch?isCat=true&keywords='+level_3.id+'&desc='+level_3.name+'>'+level_3.name+'</a></li>';
							}
						}
						htmlStr+='</ul>';
						htmlStr+='</dd>';
